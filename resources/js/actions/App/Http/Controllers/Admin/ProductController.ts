...
* @see app/Http/Controllers/Admin/ProductController.php:21
...
* @see app/Http/Controllers/Admin/ProductController.php:68
* @route '/admin/products/{product}'
*/
...
* @see app/Http/Controllers/Admin/ProductController.php:112
...
const ProductController = { index, create, store, show, edit, update, destroy, importMethod, import: importMethod }

    ...
    <div class="bg-white shadow-2xl rounded-3xl overflow-hidden">
        <div class="bg-gradient-to-r from-indigo-600 to-purple-700 px-8 py-10 text-black">
            ...
            <p class="text-4xl text-black-900">
               Welcome back, <span class="font-semibold"><?php echo e(auth('admin')->user()->name); ?></span>!
            </p>
...
<div class="mt-12 bg-white rounded-3xl shadow-2xl p-8">
    ...
    <div class="space-y-4">
        <?php if($onlineCustomers->count() == 0): ?>
            <p class="text-center text-gray-500 italic py-8">
                No customers currently online
            </p>
        <?php else: ?>
            <?php $__currentLoopData = $onlineCustomers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="flex items-center justify-between bg-gradient-to-r from-blue-50 to-cyan-50 rounded-xl p-5 shadow-md hover:shadow-lg transition">
                    <div class="flex items-center space-x-4">
                        <div class="w-12 h-12 bg-blue-500 rounded-full flex items-center justify-center text-white text-xl font-bold">
                            <?php echo e(Str::upper(substr($customer->name, 0, 1))); ?>

                        </div>
                        <div>
                            <p class="font-semibold text-gray-800 text-lg"><?php echo e($customer->name); ?></p>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\yasha\hipster-assessment\hipster-assessment\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>
...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-blue-100 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-10">
        ...
        <form class="mt-8 space-y-6" method="POST" action="<?php echo e(route('customer.login')); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div class="text-center mt-6">
                <p class="text-sm text-gray-600">
                    New here?
                    <a href="<?php echo e(route('customer.register.form')); ?>" class="font-semibold text-blue-600 hover:text-blue-500 underline">
                        Create an account
                    </a>
                </p>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\yasha\hipster-assessment\hipster-assessment\resources\views/customer/login.blade.php ENDPATH**/ ?>